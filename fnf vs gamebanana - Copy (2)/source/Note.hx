			...
			switch (PlayState.SONG.noteStyle)
			{
				...
				default:
						...
						switch(noteType)
						{
							case 2:
							{
								frames = Paths.getSparrowAtlas('notes/CustomNotes', 'shared');
							...
							case 3:
							{
								frames = Paths.getSparrowAtlas('notes/ALL_deathnotes', 'shared');
								animation.addByPrefix('greenScroll', 'green banana instance 1');
								animation.addByPrefix('redScroll', 'banana red instance 1');
								animation.addByPrefix('blueScroll', 'blue banana instance 1');
								animation.addByPrefix('purpleScroll', 'purple banana instance 1');
							...
							case 5:
							{
								loadGraphic(Paths.image('notes/warningNote', 'shared'));
								setGraphicSize(Std.int(width * 0.7));
								updateHitbox();
								antialiasing = true;
							}
