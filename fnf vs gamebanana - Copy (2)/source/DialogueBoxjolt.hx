...
class DialogueBoxjolt extends FlxSpriteGroup
{
	...
	public function new(?dialogueList:Array<String>)
	{
		...
		bgImage = new FlxSprite().loadGraphic(Paths.image('jolted/0', 'shared'));
	...
	function eOUGHGH():Void
		{
			...
			bgImage.loadGraphic(Paths.image('jolted/0', 'shared'));
